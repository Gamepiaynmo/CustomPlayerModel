...
public class CPMArmorLayer<T extends LivingEntity, M extends BipedModel<T>, A extends BipedModel<T>> extends BipedArmorLayer<T, M, A> {
    ...
    private void renderArmorLayer(MatrixStack p_241739_1_, IRenderTypeBuffer p_241739_2_, T p_241739_3_, EquipmentSlotType p_241739_4_, int p_241739_5_, ModelInstance model) {
        ...
        if (itemstack.getItem() instanceof ArmorItem) {
            ...
            A armorModel = orinLayer.func_241736_a_(p_241739_4_);
            if (armoritem.getEquipmentSlot() == p_241739_4_) {
                armorModel = getArmorModelHook(p_241739_3_, itemstack, p_241739_4_, armorModel);
                this.getEntityModel().setModelAttributes(armorModel);
                this.setModelSlotVisible(armorModel, p_241739_4_);
                ...
                if (armoritem instanceof net.minecraft.item.IDyeableArmorItem) {
                    ...
                    this.func_241738_a_(p_241739_1_, p_241739_2_, p_241739_5_, flag1, armorModel, f, f1, f2, this.getArmorResource(p_241739_3_, itemstack, p_241739_4_, null), p_241739_4_, model);
                    this.func_241738_a_(p_241739_1_, p_241739_2_, p_241739_5_, flag1, armorModel, 1.0F, 1.0F, 1.0F, this.getArmorResource(p_241739_3_, itemstack, p_241739_4_, "overlay"), p_241739_4_, model);
                } else {
                    this.func_241738_a_(p_241739_1_, p_241739_2_, p_241739_5_, flag1, armorModel, 1.0F, 1.0F, 1.0F, this.getArmorResource(p_241739_3_, itemstack, p_241739_4_, null), p_241739_4_, model);
                }
    ...
    private void func_241738_a_(MatrixStack p_241738_1_, IRenderTypeBuffer p_241738_2_, int p_241738_3_, boolean p_241738_5_, A p_241738_6_, float p_241738_8_, float p_241738_9_, float p_241738_10_, ResourceLocation armorResource, EquipmentSlotType slot, ModelInstance model) {
    ...
    private void renderModel(A armorModel, EquipmentSlotType slot, ModelInstance model, MatrixStack matrixStackIn,
        ...
        switch (slot) {
            case HEAD:
                renderCuboid(model, EnumAttachment.HELMET, armorModel.bipedHead, matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
                renderCuboid(model, EnumAttachment.HELMET, armorModel.bipedHeadwear, matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
                break;
            case CHEST:
                renderCuboid(model, EnumAttachment.CHESTPLATE_BODY, armorModel.bipedBody, matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
                renderCuboid(model, EnumAttachment.CHESTPLATE_LEFT, armorModel.bipedLeftArm, matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
                renderCuboid(model, EnumAttachment.CHESTPLATE_RIGHT, armorModel.bipedRightArm, matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
                break;
            case LEGS:
                renderCuboid(model, EnumAttachment.LEGGINGS_BODY, armorModel.bipedBody, matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
                renderCuboid(model, EnumAttachment.LEGGINGS_LEFT, armorModel.bipedLeftLeg, matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
                renderCuboid(model, EnumAttachment.LEGGINGS_RIGHT, armorModel.bipedRightLeg, matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
                break;
            case FEET:
                renderCuboid(model, EnumAttachment.BOOTS_LEFT, armorModel.bipedLeftLeg, matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
                renderCuboid(model, EnumAttachment.BOOTS_RIGHT, armorModel.bipedRightLeg, matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
                break;
        }
    }

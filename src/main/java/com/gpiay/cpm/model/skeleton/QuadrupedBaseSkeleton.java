...
public class QuadrupedBaseSkeleton<M extends CustomQuadrupedModel> extends Skeleton<M> {
    ...
    public QuadrupedBaseSkeleton(M model) {
        ...
        head = registerVanillaBone("head", model.headModel);
        body = registerVanillaBone("body", model.body);
        rightBackLeg = registerVanillaBone("right_back_leg", model.legBackRight);
        leftBackLeg = registerVanillaBone("left_back_leg", model.legBackLeft);
        rightFrontLeg = registerVanillaBone("right_front_leg", model.legFrontRight);
        leftFrontLeg = registerVanillaBone("left_front_leg", model.legFrontLeft);
    }

    ...
    public static class Instance extends ModelElement.Instance implements ModelElement.IParented, ModelElement.ITextured, IComponent {
        ...
        public void update() {
            if (parent.isVisible()) {
                ...
                boolean renderInvisible = model.entity.isInvisible() && !model.entity.isInvisibleToPlayer(Minecraft.getInstance().player);
                ...
                if (density > EPS && timer > 0) {
                    ...
                    center.x = transform.val[12] + model.entity.getPosX();
                    center.y = transform.val[13] + model.entity.getPosY() + 1.5;
                    center.z = transform.val[14] + model.entity.getPosZ();
                    ...
                    while (timer > 0) {
                        ...
                        particle.setAlpha(baseAlpha * alpha);

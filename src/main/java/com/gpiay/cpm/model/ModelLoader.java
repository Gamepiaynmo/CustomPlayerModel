...
import com.gpiay.cpm.model.element.BedrockModel;
    ...
    private static ModelPack fromJson(String id, JsonReader mainModel, List<ModelInfo.IResource> modelParts, List<ModelInfo.IResource> textures, ModelInfo.IResource script) throws IOException, ScriptException {
        ...
        for (ModelInfo.IResource texture : textures) {
            ...
            if (textureManager.getTexture(location) == null) {
                ...
                textureManager.loadTexture(location, customTexture);
            }
        }
                    ...
                    JsonHelper.readObject(mainModel, skeletonKey -> {
                        switch (skeletonKey) {
                            case "type": {
                                ...
                                LazyOptional<EnumSkeleton> type = EnumSkeleton.getBySkeletonId(skeletonId);
                        ...
                        while (mainModel.hasNext()) {
                            ...
                            switch (partKey) {
                                ...
                                case "texture": {
                                    ...
                                    for (BedrockModel part : modelPack.modelParts.get(partName))
                                        BedrockModelParser.setBedrockModelTexture(part, textureName);
                                    break;
                                }
                                default: mainModel.skipValue();
                            }
                        ...
                        JsonHelper.readObject(mainModel, partKey -> {
                            switch (partKey) {
                                case "name":
                                    ...
                                    break;
                                case "parent":
                                    particle.parentId = mainModel.nextString();
                                    break;
                                case "texture":
                        ...
                        JsonHelper.readObject(mainModel, itemKey -> {
                            switch (itemKey) {
                                case "name":
                                    ...
                                    break;
                                case "parent":
                                    itemModel.parentId = mainModel.nextString();
                                    break;
                                case "item":

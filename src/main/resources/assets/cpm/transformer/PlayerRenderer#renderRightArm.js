        ...
        'PlayerRenderer#renderRightArm': {
            ...
            'transformer': function(method) {
                ...
                var invoke = ASMAPI.buildMethodCall(
                    'com/gpiay/cpm/hook/PlayerRendererHook', 'renderRightArm',
                ...
                ASMAPI.log('INFO', '[CPMCore]: Patched PlayerRenderer#renderRightArm');
                return method;
            }
        }
    }

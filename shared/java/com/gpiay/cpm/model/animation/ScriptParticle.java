...
public class ScriptParticle {
    private final ParticleEmitter.Instance particle;

    public ScriptParticle(ParticleEmitter.Instance particle) {
    ...
    public ScriptBone getBone() { return new ScriptBone(particle.parent); }
